...
class GPUModelRunner(LoRAModelRunnerMixin):
    ...
    def _zero_cudagraph_capture_kv_blocks(self) -> None:
        # CUDA graph capture feeds dummy requests through persistent zeroed
        # dummy block tables. Those forwards may write KV cache block 0; clean
        # it before the scheduler can assign the same logical block to a real
        # request.
