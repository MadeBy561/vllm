...
def test_cudagraph_manager_excludes_uncaptured_full_candidates() -> None:
    ...
    manager.single_request_prefill_tokens = 0
...
def test_glm5next_mtp_uses_collapsed_hidden_size(monkeypatch) -> None:
    ...
    monkeypatch.setattr(loader_utils, "get_model_cls", lambda _: Glm5NextForCausalLM)
    draft_model_config = SimpleNamespace(
