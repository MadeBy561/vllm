...
"""Reasoning prefixes preserve the configured DeepSeek-V4.1 effort budgets."""
...
def test_named_and_default_effort_render_configured_numeric_budget(effort, budget):
